  ...
  return (
    <div className="bg-white rounded-xl border border-[#F0F0F0] shadow-[0_1px_3px_rgba(0,0,0,0.04)] p-5">
      <div className="mb-4">
        ...
        <p className="text-xs text-[#A8B6D6] mt-0.5">Escala de Rankin modificada · 0-2 = independencia</p>
      </div>
      {!hasData ? (
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={chartData} margin={{ top: 4, right: 8, left: -12, bottom: 0 }}>
            ...
            />
            <Legend iconType="square" iconSize={10} wrapperStyle={{ fontSize: 11, color: "#A8B6D6", paddingTop: 8 }} />
