      ...
      <div className="w-full max-w-md overflow-hidden rounded-2xl bg-stroke-navy shadow-2xl animate-slide-up">
        ...
        <div className="flex gap-2 border-t border-slate-100 px-5 py-4">
          ...
          <button
            ...
            className="flex-[1.6] rounded-lg bg-brand-600 px-4 py-3 text-sm font-bold text-white transition hover:bg-brand-700 active:scale-[0.99] disabled:bg-stroke-panel disabled:text-stroke-textMuted"
          >
            Continuar
          </button>
        </div>
  ...
  return (
    <div className="px-4 pb-4 space-y-2.5">
      ...
      <button
        ...
        disabled={!valid}
        className="w-full flex items-center justify-center gap-2 bg-brand-600 hover:bg-brand-700 active:scale-95 text-white font-semibold py-3.5 rounded-lg transition-all disabled:bg-stroke-panel disabled:text-stroke-textMuted disabled:opacity-100 disabled:cursor-not-allowed"
      >
