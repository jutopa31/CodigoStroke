...
export default function DecisionTab({ result, onGoToThrombolysis, onGoToThrombectomy }) {
  ...
  return (
    <div className="px-4 pb-4 space-y-4 animate-slide-down">
      {/* Main result card */}
      <div className={`bg-white rounded-2xl border-2 ${borderMap[icon] ?? 'border-neutral-200'} p-6`}>
        ...
        <h2 className="text-neutral-800 text-lg font-bold text-center mb-2">{title}</h2>
        <p className="text-sm text-neutral-500 text-center leading-relaxed">{body}</p>
      </div>
