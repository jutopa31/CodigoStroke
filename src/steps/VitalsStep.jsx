      ...
      <StepCard step="3" title="Signos vitales" accent="blue">
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1">
              <input
                ...
                className={`w-full border rounded-xl px-4 py-3.5 text-gray-800 text-base focus:outline-none focus:ring-2 placeholder-gray-300 ${
                  taCritical ? 'border-red-400 focus:ring-red-400' : 'border-gray-200 focus:ring-blue-400'
                }`}
              />
            </div>
            ...
            <div className="flex-1">
              <input
                ...
                className={`w-full border rounded-xl px-4 py-3.5 text-gray-800 text-base focus:outline-none focus:ring-2 placeholder-gray-300 ${
                  taDia ? 'border-red-400 focus:ring-red-400' : 'border-gray-200 focus:ring-blue-400'
                }`}
              />
            </div>
          </div>
        ...
        <div>
          ...
          <input
            ...
            className={`w-full border rounded-xl px-4 py-3.5 text-gray-800 text-base focus:outline-none focus:ring-2 placeholder-gray-300 ${
              glucLow || glucHigh ? 'border-red-400 focus:ring-red-400' : 'border-gray-200 focus:ring-blue-400'
            }`}
          />
