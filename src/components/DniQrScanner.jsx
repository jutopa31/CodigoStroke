      ...
      <div className="bg-stroke-navy rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden">
        ...
        <div className="p-4 space-y-3">
          ...
          <button
            ...
            disabled={isScanning}
            className="w-full flex items-center justify-center gap-2 bg-brand-600 hover:bg-brand-700 active:scale-[0.98] text-white font-semibold py-3.5 rounded-xl transition-all disabled:bg-stroke-panel disabled:text-stroke-textMuted disabled:cursor-wait"
          >
