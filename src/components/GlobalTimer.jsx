...
export default function GlobalTimer({ startTime }) {
  ...
  return (
    <div className={`fixed top-3 md:top-[52px] right-3 z-50 rounded-xl shadow-lg px-3 py-2 flex items-center gap-2 max-w-[calc(100vw-1.5rem)] ${getTimerColor(elapsed)} animate-fade-in`}>
